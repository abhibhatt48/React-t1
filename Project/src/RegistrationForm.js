...
const RegistrationForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <input type="text" name="firstName" onChange={handleChange} placeholder="First Name" required pattern="[A-Za-z]+" />
      <input type="text" name="lastName" onChange={handleChange} placeholder="Last Name" required pattern="[A-Za-z]+" />
      ...
      <div className="password-strength">
        ...
        <input
          type="checkbox"
          id="specialChar"
          checked={passwordStrength.specialChar}
          readOnly
        />
        ...
        <input
          type="checkbox"
          id="numberChar"
          checked={passwordStrength.numberChar}
          readOnly
        />
